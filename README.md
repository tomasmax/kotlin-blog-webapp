...
Basic blog type web app developed using kotlin and mustache
...
* [Mustache](https://docs.spring.io/spring-boot/docs/2.1.9.RELEASE/reference/htmlsingle/#boot-features-spring-mvc-template-engines)
